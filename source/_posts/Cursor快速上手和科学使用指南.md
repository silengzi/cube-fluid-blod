...
![1749179465178](images/1749179465178.png)
...
​	  可以去2925无限邮注册一个账号，这个邮箱平台的一个优势是用户申请的邮箱之后，可以自行创建子邮箱。比方说，我创建了silengzi@2925.com这个邮箱，那么我们在申请账号的时候，可以使用silengzi123@2925.com、silengziabc@2925.com、silengzi666@2925.COM等邮箱进行注册（也就是silengzi数字随意添加@2925.com），邮箱问题得以解决！注册地址： https://www.2925.com/
...
* 重置机器ID （选择1）
  ...
  ![1749175729338](images/1749175729338.png)

* 重新注册和登录即可（选择2，会跳出注册流程）

  ![1749175768340](images/1749175768340.png)
...
![1748935489544](images/1748935489544.png)
...
3. 在“VS Code Import（VS Code 导入）”下，单击“导入”按钮
   ...
   ![1748919880700](images/1748919880700.png)
...
![1748938160832](images/1748938160832.png)
...
* 测试案例说明
  ...
  ![1749222927512](images/1749222927512.png)
...
<video src="images/overview.mp4"></video>
...
![agent](images/agent-1748999380197.png)
...
![1749000583575](images/1749000583575.png)

![1749000618271](images/1749000618271.png)
...
2. 运行报错
   ...
   ![1749258831888](images/1749258831888.png)

3. 对话解决错误信息

   ![1749258891738](images/1749258891738.png)
...
![1749001781584](images/1749001781584.png)

Ask的配置选项：

![1749001991103](images/1749001991103.png)
...
![1749003780276](images/1749003780276.png)
...
![1749003672023](images/1749003672023.png)

Manual的配置选项：

![1749004551073](images/1749004551073.png)
...
1. **Review**：在差异视图中查看建议的更改
   ...
   ![1749005624183](images/1749005624183.png)

2. **Apply**:  在“ask / Manual ”模式下，使用“应用”按钮显式应用更改

   ![1749005659532](images/1749005659532.png)

3. **Accept/Reject(接受/拒绝)** ：进行更改后，决定是保留还是放弃更改(agent模式下)

   ![1749005825535](images/1749005825535.png)
...
![1749006156466](images/1749006156466.png)
...
![1749006388841](images/1749006388841.png)

开启新任务、避免对话混乱、保留特定记录或解决误操作时，需在 Cursor 的 Chat 新建聊天框。

![1749006447983](images/1749006447983.png)
...
* **内联生成**
  ...
  3. 实现效果
     ...
     ![1749009173764](images/1749009173764.png)
...
* **内联编辑**
  ...
  2. 选中init方法，按 `Cmd/Ctrl + K`，输入提示：
     ...
     ![1749009465994](images/1749009465994.png)

  3. 实现效果

     ![1749009494441](images/1749009494441.png)
...
![1749009824073](images/1749009824073.png)
...
代码库索引的状态位于 ` cursor settings >  indexing `![codebase-indexing](images/codebase-indexing.png)
...
![1749018096565](images/1749018096565.png)
...
* 使用cursor配置快捷创建忽略文件 `cursor setting > indexing >  Configure ignored files`
  ...
  ![1749020017720](images/1749020017720.png)

忽略文件配置测试：

1. 创建忽略文件

   ![1749020147156](images/1749020147156.png)
...
4. 效果展示
   ...
   ![1749020220373](images/1749020220373.png)
...
1. 项目下创建规则文件
   ...
   * 快捷命令方式创建 `Ctrl + Shift + P` > “New Cursor Rule”
   ...
   ![1749025679441](images/1749025679441.png)
...
4. 项目规则生效效果展示
   ...
   ![1749026002745](images/1749026002745.png)
...
2. 添加规则内容即可
   ...
   ![1749027746719](images/1749027746719.png)
...
![@-symbols-basics](images/@-symbols-basics.png)
...
3. 查看对话结果
   ...
   ![1749032749858](images/1749032749858.png)
...
3. 查看对话结果
   ...
   ![1749033073362](images/1749033073362.png)
...
2. @Docs对应文档配置
   ...
   ![1749087430503](images/1749087430503.png)
...
4. 查看对话结果
   ...
   ![1749088442648](images/1749088442648.png)
...
3. 查看对话结果
   ...
   ![1749089800111](images/1749089800111.png)

4. 对比@Docs和MCP配置

   ![docsweb和mcp](images/docsweb和mcp.png)
...
4. 测试结果
   ...
   ![1749090456352](images/1749090456352.png)

## 五、Cursor智能插件开发实战

Cursor官网开发指导流程：

![1749111107526](images/1749111107526.png)
...
3. 配置和导入kimi docs文档
   ...
   ![1749112017898](images/1749112017898.png)
...
4. 生成kimi api key
   ...
   ![1749112182526](images/1749112182526.png)

### 5.2 Chrome插件实现

1. 准备一个参考界面（参考豆包）

   ![doubaoui](images/doubaoui.png)
...
1. 第一次回出现问题（使用cursor调试）
   ...
   ![1749113898720](images/1749113898720.png)
...
2. 有错误信息显示
   ...
   ![1749114738303](images/1749114738303.png)
...
3. 确保添加完成
   ...
   ![1749114867360](images/1749114867360.png)
